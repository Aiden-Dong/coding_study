...
/********  迪杰斯特拉算法 ****************/
typedef int Patharc[MAX_SIZE];			// 存取最短路径下标的数组
typedef int ShortPathTable[MAX_SIZE];	// 存取到各个最短路径的权值之和

void ShorttestPath_Difkstar (pMGraph G , int vo , Patharc p , ShortPathTable D );
// 迪杰斯特拉算法  求解最短路径
