...
# 257 "/usr/include/x86_64-linux-gnu/bits/siginfo.h" 3 4
enum
{
  CLD_EXITED = 1,
...
# 90 "client.c"
 ...
 if(atoi(argv[1]) == 1)
  msg_sqe.cts_events = 2;
 else if(atoi(argv[1]) == 2)
                msg_sqe.cts_events = 1;
...
# 109 "client.c" 3 4
          2
# 109 "client.c"
                 , "192.168.1.100", (void *)&sock_addr_ip);
